    ...
    <div class="sendpwd-container">
        <el-form autoComplete="on" :model="resetForm" :rules="resetRules" ref="resetForm" label-position="left"
            ...
            <div>
                ...
                <h3 class="title">Send a verification code to the mailbox</h3>
            </div>
            <el-form-item prop="email">
                <el-input name="email" type="text" v-model="resetForm.email"></el-input>
            </el-form-item>
...
<script>
    ...
    import { sendPWD2Email } from '../api/api.js'
    export default {
      data() {
      ...
      methods: {
        handleSendPWD() {
          ...
          this.$refs.resetForm.validate(valid => {
            if (valid) {
              let p = {'email': this.resetForm.email}  
              sendPWD2Email(p).then(() => {
