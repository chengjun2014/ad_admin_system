	...
	exports.default = {
		data: function data() {
			return {
				...
				editLoading: false,
				editFormRules: {
					title: [{ required: true, message: '请输入推广计划名称', trigger: 'blur' }]
				},
		...
		methods: {
			...
			getCampaigns: function getCampaigns() {
				...
				(0, _api.getCampaignList)(para).then(function (res) {
			...
			query: function query() {
				...
				(0, _api.campaignQuery)(para).then(function (res) {
			...
			handleDel: function handleDel(index, row) {
				...
				this.$confirm('确认删除该记录吗?', '提示', {
					...
					(0, _api.editCampaign)(para).then(function (res) {
	  ...
	  return _c('section', [_c('el-col', {
	    ...
	    scopedSlots: _vm._u([{
	      ...
	      fn: function(scope) {
	        ...
	        }, [_vm._v("新增推广组")]), _vm._v(" "), _c('el-button', {
	          attrs: {
	            "size": "small"
	          },
	          on: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(true) {
		...
		if(!content.locals) {
			module.hot.accept(633, function() {
				var newContent = __webpack_require__(633);
