...
/***/ function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('section', [_c('el-form', {
	  ...
	  }, [_c('el-row', [_c('label', [_vm._v("推广计划")]), _vm._v(" "), _c('el-select', {
	    attrs: {
	      "placeholder": "请选择"
	    },
	    on: {
	      "visible-change": _vm.campaignSelect
	    },
	    model: {
	      value: (_vm.addForm.campaign_id),
	      callback: function($$v) {
	        _vm.addForm.campaign_id = $$v
	      },
	      expression: "addForm.campaign_id"
	    }
	  ...
	  }, [_c('el-row', [_c('el-radio', {
	    staticClass: "radio",
	    attrs: {
	      "label": 1
	    }
	  }, [_vm._v("标准展示推广 - 在PC媒体流量中站上投放的展示推广")])], 1), _vm._v(" "), _c('el-row', [_c('el-radio', {
	    staticClass: "radio",
	    attrs: {
	      "label": 2
	    }
	  }, [_vm._v("移动展示推广 - 在移动媒体流量中站上投放的展示推广")])], 1)], 1)], 1), _vm._v(" "), _c('el-form-item', {
	    attrs: {
	      "label": "投放时间",
	      "prop": "start_time"
	    }
	    ...
	    domProps: {
	      "checked": Array.isArray(_vm.flow) ? _vm._i(_vm.flow, "阿里") > -1 : (_vm.flow)
	    },
	    on: {
	      "__c": function($event) {
	        var $$a = _vm.flow,
	        ...
	        if (Array.isArray($$a)) {
	          var $$v = "阿里",
	            $$i = _vm._i($$a, $$v);
	          if ($$el.checked) {
	            $$i < 0 && (_vm.flow = $$a.concat([$$v]))
	          } else {
	            $$i > -1 && (_vm.flow = $$a.slice(0, $$i).concat($$a.slice($$i + 1)))
	          }
	        } else {
	          _vm.flow = $$c
	        }
	    ...
	    domProps: {
	      "checked": Array.isArray(_vm.flow) ? _vm._i(_vm.flow, "腾讯") > -1 : (_vm.flow)
	    },
	    on: {
	      "__c": function($event) {
	        var $$a = _vm.flow,
	    ...
	    domProps: {
	      "checked": Array.isArray(_vm.flow) ? _vm._i(_vm.flow, "百度") > -1 : (_vm.flow)
	    },
	    on: {
	      "__c": function($event) {
	        var $$a = _vm.flow,
	  ...
	  }, [_vm._v("百度")])]), _vm._v(" "), _c('el-form-item', {
	    attrs: {
	      "label": "投放渠道",
	      "prop": "qudao"
	    }
	  ...
	  }, [_vm._v("全网智能投放")])]), _vm._v(" "), _c('el-form-item', {
	    attrs: {
	      "label": "推广位样式",
	      "prop": "style"
	    }
	    ...
	    domProps: {
	      "checked": Array.isArray(_vm.checkedNames) ? _vm._i(_vm.checkedNames, "阿里") > -1 : (_vm.checkedNames)
	    },
	    on: {
	      "__c": function($event) {
	    ...
	    domProps: {
	      "checked": Array.isArray(_vm.checkedNames) ? _vm._i(_vm.checkedNames, "腾讯") > -1 : (_vm.checkedNames)
	    },
	    on: {
	      "__c": function($event) {
	        var $$a = _vm.checkedNames,
	    ...
	    domProps: {
	      "checked": Array.isArray(_vm.checkedNames) ? _vm._i(_vm.checkedNames, "百度") > -1 : (_vm.checkedNames)
	    },
	    on: {
	      "__c": function($event) {
	        var $$a = _vm.checkedNames,
	  ...
	  }, [_vm._v("固定")])]), _vm._v(" "), _c('el-form-item', {
	    attrs: {
	      "label": "定向人群",
	      "prop": "people"
	    }
	    ...
	    domProps: {
	      "checked": Array.isArray(_vm.tag) ? _vm._i(_vm.tag, "阿里") > -1 : (_vm.tag)
	    },
	    on: {
	      "__c": function($event) {
	        var $$a = _vm.tag,
	        ...
	        if (Array.isArray($$a)) {
	          ...
	          if ($$el.checked) {
	            ...
	            $$i > -1 && (_vm.tag = $$a.slice(0, $$i).concat($$a.slice($$i + 1)))
	          }
	        } else {
	          _vm.tag = $$c
	        }
	  ...
	  }, [_vm._v("地域，人群")])]), _vm._v(" "), _c('el-form-item', {
	    attrs: {
	      "label": "关键词",
	      "prop": "keyword"
	    }
	    ...
	    model: {
	      value: (_vm.addForm.keyword),
	      callback: function($$v) {
	        _vm.addForm.keyword = $$v
	      },
	    ...
	    domProps: {
	      "checked": _vm._q(_vm.pricetype, "One")
	    },
	    on: {
	      "__c": function($event) {
	        _vm.pricetype = "One"
	    ...
	    domProps: {
	      "checked": _vm._q(_vm.pricetype, "Two")
	    },
	    on: {
	      "__c": function($event) {
	        _vm.pricetype = "Two"
	  ...
	  }, [_vm._v("CPM")])]), _vm._v(" "), _c('el-form-item', {
	    attrs: {
	      "label": "出价",
	      "prop": "price"
	    }
	    ...
	    model: {
	      value: (_vm.addForm.bid_price),
	      callback: function($$v) {
	        _vm.addForm.bid_price = $$v
	      },
	      expression: "addForm.bid_price"
	    }
	  })], 1), _vm._v(" "), _c('el-form-item', {
	    attrs: {
	      "label": "是否启动",
